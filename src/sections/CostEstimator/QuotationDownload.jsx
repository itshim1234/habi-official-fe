...
function QuotationDownload({
  ...
  const handleContinue = async () => {
    if (validateInput()) {
      ...
      formData.append("package", package1);
  ...
  return (
    <div className="flex justify-center items-center relative">
      ...
      {popUp && (
        <>
          <div className="fixed inset-0 bg-black/20 backdrop-blur-md z-10"></div>

          <div className="fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[90%] md:w-fit h-fit bg-black/50 backdrop-blur-lg flex justify-center items-center z-20 border border-[#7c7c7c] rounded-3xl">
            <button
