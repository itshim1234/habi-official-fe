...
function QuotationDownload() {
  ...
  return (
    <div className="flex justify-center items-center relative">
      ...
      {popUp && (
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-fit h-fit bg-black/50 backdrop-blur-lg flex justify-center items-center z-20 border border-[#7c7c7c] rounded-3xl">
          <button
