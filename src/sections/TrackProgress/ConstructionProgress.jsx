...
const ConstructionProgress = () => {
  ...
  return (
    <div
      ref={sectionRef}
      className="relative min-h-screen bg-cover bg-center w-full mb-20 mt-10"
    >
      {/* Centered Video */}
      ...
      {/* Card Section */}
      <div
        className={`absolute z-10 flex flex-col sm:flex-row justify-center gap-4 px-6 mt-10 sm:mt-16 transition-opacity duration-1000 ${
