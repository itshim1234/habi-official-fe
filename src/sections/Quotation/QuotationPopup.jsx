...
function QuotationPopup({ isVisible, onClose, quotationData }) {
  ...
  return (
    <div className="fixed bg-black/20 backdrop-blur-md z-50 flex items-center rounded-3xl">
      <div className="w-[90%] md:w-fit h-fit flex justify-center items-center border border-[#7c7c7c] rounded-3xl relative p-6 md:p-10">
        ...
        <div className="flex flex-col items-center">
          <h2 className="text-3xl font-bold mb-2 text-secondary">Quotation</h2>
          ...
          />
          <button
            className="text-black bg-white rounded-lg px-4 py-2 mt-5"
